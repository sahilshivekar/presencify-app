...
object ApiEndpoints {
    ...
    val CREATE_ATTENDANCE = "$PRESENCIFY_BASE_URL/$API_V1/$ATTENDANCES"
    val REMOVE_ATTENDANCE = "$PRESENCIFY_BASE_URL/$API_V1/$ATTENDANCES"
    val GET_ATTENDANCES = "$PRESENCIFY_BASE_URL/$API_V1/$ATTENDANCES"
    val GET_ATTENDANCE_BY_ID = "$PRESENCIFY_BASE_URL/$API_V1/$ATTENDANCES"

    val UPDATE_STUDENT_ATTENDANCE = "$PRESENCIFY_BASE_URL/$API_V1/$ATTENDANCES/students"
