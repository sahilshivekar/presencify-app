...
class StudentAttendanceAnalyticsViewModel(
    ...
    private val studentId = routeParams.studentId
    ...
    private suspend fun loadSemesterAttendance(semesterId: String) {
            ...
            viewModelScope.async {
                attendanceRepository.getAttendanceOfAnyStudentForSpecificCourseInSemester(
                    ...
                    semesterNumber = routeParams.semesterNumber?.let {
                        edu.watumull.presencify.core.domain.enums.SemesterNumber.entries.find { s -> s.value == it.toInt() }
                    },
        ...
        val aggregatedAttendance = mutableListOf<edu.watumull.presencify.core.domain.model.attendance.AggregatedAttendance>()
        val detailedAttendanceMap = mutableMapOf<String, List<edu.watumull.presencify.core.domain.model.attendance.DetailedAttendanceRecord>>()
