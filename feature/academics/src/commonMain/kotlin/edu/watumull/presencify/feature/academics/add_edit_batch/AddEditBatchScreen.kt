...
fun AddEditBatchScreen(
    ...
    PresencifyScaffold(
        ...
        if (state.isEditMode && state.isLoadingBatchDetails) {
                ...
                Column(
                    ...
                    if (!state.isEditMode) {
                        ...
                        PresencifyDropDownMenuBox<SemesterNumber>(
                            ...
                            onDropDownVisibilityChanged = {
                                onAction(
                                    AddEditBatchAction.ChangeSemesterNumberDropDownVisibility(
                                        it
                                    )
                                )
                            },
                        ...
                        PresencifyDropDownMenuBox<Branch>(
                            ...
                            onDropDownVisibilityChanged = {
                                onAction(
                                    AddEditBatchAction.ChangeBranchDropDownVisibility(
                                        it
                                    )
                                )
                            },
                    ...
                    if (!state.isEditMode && state.showDivisionInput && state.foundDivisions.isNotEmpty()) {
                        ...
                        PresencifyDropDownMenuBox<Division>(
                            ...
                            onDropDownVisibilityChanged = {
                                onAction(
                                    AddEditBatchAction.ChangeDivisionDropDownVisibility(
                                        it
                                    )
                                )
                            },
