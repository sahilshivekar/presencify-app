...
@Composable
fun SearchBatchBottomSheetContent(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                modifier = Modifier.clickable {
                    onAction(SearchBatchAction.ResetFilters)
                }
            )
        }
                    ...
                    state.semesterNumberOptions.forEach { semesterNumber ->
                        FilterChip(
                            ...
                            onClick = {
                                ...
                                onAction(SearchBatchAction.SelectSemesterNumber(newSemester))
                            },
            ...
            FilterSection(title = "Academic Year") {
                Row(
                    ...
                    PresencifyTextField(
                        ...
                        onValueChange = { onAction(SearchBatchAction.UpdateAcademicStartYear(it)) },
                        label = "Start Year *",
                        modifier = Modifier.weight(1f)
                    )
                    PresencifyTextField(
                        value = state.academicEndYear,
                        onValueChange = { onAction(SearchBatchAction.UpdateAcademicEndYear(it)) },
                        label = "End Year *",
                        modifier = Modifier.weight(1f)
                    )
                }
                    ...
                    state.branchOptions.forEach { branch ->
                        FilterChip(
                            ...
                            onClick = {
                                ...
                                onAction(SearchBatchAction.SelectBranch(newBranch))
                            },
                    ...
                    state.divisionOptions.forEach { division ->
                        FilterChip(
                            ...
                            onClick = {
                                ...
                                onAction(SearchBatchAction.SelectDivision(newDivision))
                            },
        ...
        PresencifyButton(
            onClick = {
                onDismiss()
                onAction(SearchBatchAction.ApplyFilters)
            },
            modifier = Modifier
                .fillMaxWidth()
