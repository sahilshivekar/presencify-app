...
@Composable
fun SearchSemesterBottomSheetContent(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                modifier = Modifier.clickable {
                    onAction(SearchSemesterAction.ResetFilters)
                }
            )
        }
                    ...
                    state.semesterNumberOptions.forEach { semesterNumber ->
                        FilterChip(
                            ...
                            onClick = {
                                ...
                                onAction(SearchSemesterAction.SelectSemesterNumber(newSemester))
                            },
                ...
                Row(
                    ...
                    state.branchOptions.forEach { branch ->
                        FilterChip(
                            ...
                            onClick = { onAction(SearchSemesterAction.ToggleBranch(branch)) },
                    ...
                    state.schemeOptions.forEach { scheme ->
                        FilterChip(
                            ...
                            onClick = {
                                ...
                                onAction(SearchSemesterAction.SelectScheme(newScheme))
                            },
        ...
        PresencifyButton(
            onClick = {
                onDismiss()
                onAction(SearchSemesterAction.ApplyFilters)
            },
            modifier = Modifier
                .fillMaxWidth()
