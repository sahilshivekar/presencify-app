...
class ImportStudentsViewModel(
             ...
             is ImportStudentsAction.CsvFileSelected -> {
                when(val result = action.result) {
                    is CsvPickerResult.Success -> {
                        ...
                        val validationError = validateStudentCsv(csvContent)
    ...
    private fun validateStudentCsv(csvContent: String): String? {
        ...
        val requiredColumns = listOf(
            ...
            "gender", "schemeId", "admissionYear", "admissionType", "branchId"
        )
